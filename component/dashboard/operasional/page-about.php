...
<div id="page">
    ...
    <div class="page-content pb-0">
        ...
        <div class="page-title page-title-small">
            <h2><a href="#" data-back-button></a>Operational</h2>
        ...
        <div data-card-height="cover-card" class="card bg-transparent">
            <div class="card-center text-center">
                ...
                <div class="row mx-auto mt-3 mb-0" style="max-width:330px;">
                    <a href="#" id="confirmPickupLink"  class="col-4">
...
<script>
    document.getElementById('confirmPickupLink').addEventListener('click', function() {
        // Set the location.href to the desired URL
        location.href = 'terima-pickup.php';
    });
