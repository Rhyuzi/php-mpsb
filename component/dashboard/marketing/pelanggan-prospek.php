...
<div id="page">
    ...
    <div class="page-content" style="min-height:60vh!important">
        <div class="page-title page-title-small">
            <h2><a href="page-about.php" data-back-button><i class="fa fa-arrow-left"></i></a>Pelanggan Prospek</h2>
        ...
        <div class="card card-style">
            <div class="content mb-0">        
                ...
                <div class="input-style input-style-2 input-required">
                    <span class="color-highlight">Area Kiriman</span>
                    <em>(required)</em>
                    <input id="areakirim" class="form-control" name="areakirim" type="name" placeholder="">
                    <small id="areakirim-error" class="text-danger" style="display:none">alamat harus diisi</small>
                </div>  

                <label for="">Budget Logistik Rp.</label>
                <div class="display-flex">
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Express</span>
                        <em>(required)</em>
                        <input id="potency1" class="form-control" name="potency1" type="name" placeholder="">
                        <!-- <small id="potency1-error" class="text-danger" style="display:none">alamat harus diisi</small> -->
                    </div>  
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Cargo</span>
                        <em>(required)</em>
                        <input id="potency2" class="form-control" name="potency2" type="name" placeholder="">
                        <!-- <small id="potency2-error" class="text-danger" style="display:none">alamat harus diisi</small> -->
                    </div>  
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Trucking</span>
                        <em>(required)</em>
                        <input id="potency3" class="form-control" name="potency3" type="name" placeholder="">
                        <!-- <small id="potency3-error" class="text-danger" style="display:none">alamat harus diisi</small> -->
                    </div>  
                </div>
                <small id="bgtlogis-error" class="text-danger" style="display:none">alamat harus diisi</small>
                ...
                <div class="display-flex">
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Express</span>
                        <em>(required)</em>
                        <input id="kompetitor1" class="form-control" name="kompetitor1" type="name" placeholder="">
                        <small id="kompetitor1-error" class="text-danger" style="display:none">alamat harus diisi</small>
                    </div>  
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Cargo</span>
                        <em>(required)</em>
                        <input id="kompetitor2" class="form-control" name="kompetitor2" type="name" placeholder="">
                        <small id="kompetitor2-error" class="text-danger" style="display:none">alamat harus diisi</small>
                    </div>  
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Trucking</span>
                        <em>(required)</em>
                        <input id="kompetitor3" class="form-control" name="kompetitor3" type="name" placeholder="">
                        <small id="kompetitor3-error" class="text-danger" style="display:none">alamat harus diisi</small>
                    </div>  
                </div>   
                ...
                <label for="">PIC.Order</label>
                <div class="display-flex">
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Nama</span>
                        <em>(required)</em>
                        <input id="contactname1" name="contactname1" class="form-control" type="name" placeholder="">
                        <!-- <small id="contactname1-error" class="text-danger" style="display:none">PIC harus diisi</small> -->
                    </div>
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Telp/Hp</span>
                        <em>(required)</em>
                        <input id="contacttlp1" name="contacttlp1" class="form-control" type="name" placeholder="">
                        <!-- <small id="contacttlp1-error" class="text-danger" style="display:none">PIC harus diisi</small> -->
                    </div>
                </div>   
                <small id="picorder-error" class="text-danger" style="display:none">PIC harus diisi</small>

                <label for="">PIC.Keuangan</label>
                <div class="display-flex">
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Nama</span>
                        <em>(required)</em>
                        <input id="contactname2" name="contactname2" class="form-control" type="name" placeholder="">
                        <small id="contactname2-error" class="text-danger" style="display:none">PIC harus diisi</small>
                    </div>
                    <div class="input-style input-style-2 input-required">
                        <span class="color-highlight">Telp/Hp</span>
                        <em>(required)</em>
                        <input id="contacttlp2" name="contacttlp2" class="form-control" type="name" placeholder="">
                        <small id="contacttlp2-error" class="text-danger" style="display:none">PIC harus diisi</small>
                    </div>
                </div>   
                ...
                <div class="input-style input-style-2 input-required">
                    <span class="color-highlight">Usia Tagihan</span>
                    <em>(required)</em>
                    <input id="payperiode" name="payperiode" class="form-control" type="name" placeholder="">
                    <small id="payperiode-error" class="text-danger" style="display:none">PIC harus diisi</small>
                </div>
...
function validateForm() {
    ...
    var potency1 = document.getElementById('potency1').value;
    var potency2 = document.getElementById('potency2').value;
    var potency3 = document.getElementById('potency3').value;

    var contactname1 = document.getElementById('contactname1').value;
    var contacttlp1 = document.getElementById('contacttlp1').value;
    ...
    var bgtlogisError = document.getElementById('bgtlogis-error');
    var picorder = document.getElementById('picorder-error');


    // nama perusahaan
    if (contactname1.trim() === '' || contacttlp1.trim() === '' ) {
        picorder.textContent = 'Pic Order harus diisi';
        picorder.style.display = 'block';
        isValid = false;
    } else{
        picorder.style.display = 'none';
    }

    if (potency1.trim() === '' || potency2.trim() === '' || potency3.trim() === '') {
        bgtlogisError.textContent = 'Budget Logistik harus diisi';
        bgtlogisError.style.display = 'block';
        isValid = false;
    } else{
        bgtlogisError.style.display = 'none';
    }
