...
<div id="page">
    ...
    <div class="page-content pb-0">
        ...
        <div class="page-title page-title-small">
            <h2><a href="#" data-back-button></a>Marketing</h2>
        ...
        <div data-card-height="cover-card" class="card bg-transparent">
            <div class="card-center text-center">
                ...
                <div class="row mx-auto mt-3 mb-0" style="max-width:330px;">
                    <a href="#" id="prospekLink"  class="col-4">
                        <i data-feather="user" data-feather-line="1" data-feather-size="55" data-feather-color="green1-dark" data-feather-bg="green1-fade-light"></i>
                    ...
                    <a href="#" id="salesKunjungLink" class="col-4">
                        <i data-feather="users" data-feather-line="1" data-feather-size="55" data-feather-color="blue2-dark" data-feather-bg="blue2-fade-light"></i>
                        <p>Kunjungan Sales</p>
                    </a>
...
<script>
    document.getElementById('prospekLink').addEventListener('click', function() {
        // Set the location.href to the desired URL
        location.href = 'pelanggan-prospek.php';
    });
    document.getElementById('salesKunjungLink').addEventListener('click', function() {
        // Set the location.href to the desired URL
        location.href = 'form-sales-kunjung.php';
    });
</script>
</body>
